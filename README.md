...
- **New Draft**: password-protected, click "Load example," then "Draft justification."
- **Outcomes Log**: should show the case you just drafted; mark it Approved and watch the calibration chart update.
